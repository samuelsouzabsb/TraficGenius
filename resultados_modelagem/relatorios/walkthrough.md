...
![Comparação de Métricas](C:/Users/samue/.gemini/antigravity/brain/ceea9544-b160-4a30-9d87-8e0226e648e7/comparativo_performance_binaria.png)
...
````carousel
![Matriz Logística](C:/Users/samue/.gemini/antigravity/brain/ceea9544-b160-4a30-9d87-8e0226e648e7/matriz_confusao_logistic_regression.png)
<!-- slide -->
![Matriz LDA](C:/Users/samue/.gemini/antigravity/brain/ceea9544-b160-4a30-9d87-8e0226e648e7/matriz_confusao_lda.png)
<!-- slide -->
![Matriz Random Forest](C:/Users/samue/.gemini/antigravity/brain/ceea9544-b160-4a30-9d87-8e0226e648e7/matriz_confusao_random_forest.png)
<!-- slide -->
![Matriz MLP](C:/Users/samue/.gemini/antigravity/brain/ceea9544-b160-4a30-9d87-8e0226e648e7/matriz_confusao_neural_network_mlp.png)
<!-- slide -->
![Matriz XGBoost](C:/Users/samue/.gemini/antigravity/brain/ceea9544-b160-4a30-9d87-8e0226e648e7/matriz_confusao_xgboost.png)
<!-- slide -->
![Matriz Stacking](C:/Users/samue/.gemini/antigravity/brain/ceea9544-b160-4a30-9d87-8e0226e648e7/matriz_confusao_stacking_ensemble.png)
````
...
![Importância das Features XGBoost](C:/Users/samue/.gemini/antigravity/brain/ceea9544-b160-4a30-9d87-8e0226e648e7/importancia_features_xgboost_binaria.png)
...
![Distribuição de Normalidade](C:/Users/samue/.gemini/antigravity/brain/ceea9544-b160-4a30-9d87-8e0226e648e7/distribuicao_normalidade_binaria.png)

### Fator de Inflação da Variância (VIF)
Mantivemos todas as variáveis contínuas com VIF abaixo de 10.0, garantindo a ausência de multicolinearidade.

![VIF Colinearidade](C:/Users/samue/.gemini/antigravity/brain/ceea9544-b160-4a30-9d87-8e0226e648e7/vif_multicolinearidade_binaria.png)

---

## 📊 Fase de Diagnósticos Estatísticos e Storytelling (Modelo com Flag de País)

Realizamos a validação estatística formal das premissas e a geração de visualizações científicas de alto impacto para o modelo final com Flag de País:

1. **Diagnósticos Formais**: Calculados via [pipeline_diagnosticos_estatisticos.py](file:///C:/Users/samue/Documents/trafic/pipeline_diagnosticos_estatisticos.py) e salvos em [diagnosticos_estatisticos.json](file:///C:/Users/samue/Documents/trafic/dataset/diagnosticos_estatisticos.json).
   - **Outliers**: 6.63% de outliers multivariados detectados pela Distância de Mahalanobis ($D^2 > 56.89$).
   - **Normalidade**: Rejeitada pelos testes de Jarque-Bera, Shapiro-Wilk e Kolmogorov-Smirnov ($p < 0.01$).
   - **Homocedasticidade**: Rejeitada pelo teste Breusch-Pagan ($p < 0.01$).
   - **Independência dos Erros**: Confirmada (Durbin-Watson = 1.997, Runs Test $p$-value = 0.979).
   - **Ausência de Multicolinearidade**: Confirmada (VIF máximo = 4.25 em `ponto_orvalho_celsius`, Condition Index máximo = 4.32).
   - **RESET de Ramsey**: Rejeita linearidade ($p < 0.01$), justificando a modelagem não-linear do comitê.
2. **Storytelling Visual**: Visualizações geradas via [gerar_graficos_storytelling.py](file:///C:/Users/samue/Documents/trafic/gerar_graficos_storytelling.py) e salvas na pasta de artefatos.
   - **EDA**: Densidades KDE, Boxplots comparativos, Correlação e Coordenadas Paralelas.
   - **Premissas**: NPP Q-Q Plot, Resíduos vs. Ajustados, Correlograma ACF e VIF.
   - **Desempenho**: Curvas ROC, Precision-Recall, Calibração, Lift & Ganho Acumulado, Projeção t-SNE e SHAP Summary Plot.

O relatório completo detalhado com todas as análises e discussões científicas está documentado no arquivo [storytelling_modelagem.md](file:///C:/Users/samue/.gemini/antigravity/brain/ceea9544-b160-4a30-9d87-8e0226e648e7/storytelling_modelagem.md).
